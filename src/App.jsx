...
const APP_VERSION_STAMP = "v2026-06-04-1004-smartsheet-read-write";
...
function NeighborhoodRotations({ onBackToPlatform }) {
  ...
  const persistRotationToDatabase = async (nextRotation) => {
    ...
    try {
      ...
      setDatabaseSyncStatus({ state: "fallback", message: error.message || "Smartsheet sync failed. Local fallback saved.", syncedAt: nowStamp() });
    }
  };
