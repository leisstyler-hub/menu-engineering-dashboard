          ...
          <>
            ...
            <section className="grid grid-cols-1 xl:grid-cols-3 gap-6">
              <div className="xl:col-span-2 space-y-6">
                <RotationPlannerCard cafe={selectedCafe} menuOptions={menus} rotation={currentRotation} updateRotation={updateRotation} />
              </div>
...
function RotationPlannerCard({ cafe, menuOptions, rotation, updateRotation }) {
  ...
  return (
    <div className="rounded-[2rem] bg-white border border-slate-200 p-6 shadow-2xl">
      ...
      <CopyWeekPanel copiedRotation={copiedRotation} onCopy={copyCurrentRotation} onLoad={loadCopiedRotation} />
      <WeekAtGlanceUpload cafe={cafe} preview={preview} setPreview={setPreview} applyPreview={applyPreview} />
