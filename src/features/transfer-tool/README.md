...
- Each transfer line shows one compact, collapsed allocation summary by default. Expanding it reveals every ingredient, source MRN, G/L, substitute/residual note, original pre-cap cost, proportional adjustment, unresolved component, and reconciliation total.
