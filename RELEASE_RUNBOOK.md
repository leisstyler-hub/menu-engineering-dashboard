...
6. If production behavior doesn't match expectations, Release rolls back and reports `ROLLED BACK` with the evidence, rather than leaving the state ambiguous.
